Shader "Toon/Realistic"
{
    Properties
    {
        ...
        _RimThreshold ("Rim Threshold", Range(0.0, 1.0)) = 0.1 // Added for rim modulation
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert_outline (appdata v)
            {
                ...
                // Task 1-2. Implement the Outline Shader (2 points)
        ...
        Pass
        {
            ...
            v2f vert_main (appdata v)
            {
                ...
                // Task 0. Implement the vertex shader (1 point)
